...
export default function LogsPageClient({ gymId }: LogsPageClientProps) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow">
      ...
      {!features.extended_campaign_history && (
        <div className="mb-4 rounded-lg border border-lime-200 bg-lime-50 px-4 py-3 text-sm text-gray-700">
          Showing the last {STARTER_LOG_HISTORY_DAYS} days.{" "}
          <Link href="/settings#subscription" className="font-medium text-lime-700 hover:underline">
            Upgrade to Growth
          </Link>{" "}
          for extended campaign history.
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="rounded-xl border-2 border-dashed border-gray-200 bg-gray-50/50 p-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500 max-w-md mx-auto">
            Intervention logs will appear here once you create plays and enable auto-interventions. Check the Plays tab to get started.
          </p>
        </div>
      ) : (
